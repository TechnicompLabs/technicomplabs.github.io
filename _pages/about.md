...
**Projects.** The lab's main project is [Technicomp Benchtop Linux](/benchtop/), the operating system for the technical workbench. Other work is released openly where licensing allows, including the [LLM Performance Engineering Notebook](https://github.com/pauldmartinphd/llm-performance-engineering-notebook), an open lab notebook on the inference speed limits of large Mixture-of-Experts models.
