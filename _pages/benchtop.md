...
Even though the system uses a rolling release model, it has LTS core packages and a GNOME Oldstable desktop. Security fixes arrive promptly, with no major-version upgrades. Every update is a snapshot that can be rolled back.
